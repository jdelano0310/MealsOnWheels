...
Partial Class frmDelivery
    ...
    Private Sub InitializeComponent()
        ...
        ' txtCity
        ' 
        txtCity.Location = New Point(71, 152)
        ...
        ' txtAddress
        ' 
        txtAddress.Location = New Point(71, 126)
        ...
        lblFilterType1.Location = New Point(4, 99)
        ...
        cboRecipients.Location = New Point(70, 99)
        cboRecipients.Name = "cboRecipients"
        cboRecipients.Size = New Size(235, 23)
